...
```bash
llama-server -m "/Users/ricky/Desktop/Flow Health App/flow-ocr/chandra_ocr/models/Chandra-OCR-Q4_K_M.gguf" --mmproj "/Users/ricky/Desktop/Flow Health App/flow-ocr/chandra_ocr/models/mmproj-F32.gguf" --ctx-size 8192 -ngl 999
```
